...
function htmlEntities (): array {
    // a table of HTML entites to reverse. static so that once built,
...
abstract class DOMTemplateNode
{
    ...
    private function create_fragment (
        ...
        $frag->appendXML(
            ...
            $this->type == TYPE_HTML ? self::toXML( $text ) : $text
        );
        return $frag;
    }
